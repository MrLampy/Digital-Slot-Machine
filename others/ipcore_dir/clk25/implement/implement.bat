...
xst -ifn xst.scr
move clk25_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clk25_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clk25_exdes.ucf clk25_exdes

echo 'Running map'
map -timing -pr b clk25_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm clk25_exdes -w routed.ncd routed.v
cd ..
